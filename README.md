...
<img src="docs/screenshots/web-demo-v1.3.png" alt="Life Launcher Web Demoの「今日やるものを選ぶ」画面、今日の3件、次の一手、やりたいこと" width="960">

## できること

Life Launcher v1.3の中心的な流れを、ブラウザ上のサンプルデータで体験できます。

- 「今日の勝利条件」の編集・達成と、プロジェクトの色に沿う「今やる一手」の切り替え
- プロジェクトごとの次の一手と、プロジェクト別または未分類のやりたいことを登録
- 「今日やるものを選ぶ」画面で次の一手・やりたいことから最大3件を選択
- 「今日の3件」で使用中の元の項目を保護
...
- 新しく試す場合、学習・運動・読書の3件のプロジェクトが用意されています。新規登録はやりたいことから行い、プロジェクトの次の一手はタイマー満了時に編集できます。以前の保存内容はそのまま残ります。
